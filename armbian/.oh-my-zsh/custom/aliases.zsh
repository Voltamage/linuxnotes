...
alias update='bash -c "$(curl -fsSL https://raw.githubusercontent.com/voltamage/notes/master/armbian/tmp/patch)" && cp ~/scripts/updater /tmp/updater && curl https://raw.githubusercontent.com/voltamage/notes/master/armbian/scripts/updater > ~/scripts/updater -# && /home/$USER/scripts/updater'
